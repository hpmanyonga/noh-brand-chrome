...
2. **The compliance footer line:** "A service of Network One Health. Clinical protocols developed by Dr H P Manyonga & Associates Inc. Practice No. 0977357." Inject the practice number via the `hpcsaPR` prop (name kept for backwards compatibility); don't edit other wording. NOTES: (a) the practice is identified by its **Practice Number**, never an "HPCSA PR"/MP number — HP rule 2026-05-26. (b) The practice is named as **developer of the binding clinical protocols**, not "services provided by" — NOH may not provide the service, but its protocols are non-negotiable for any team in the network — HP rule 2026-06-29. Both override the older "Clinical services provided by … HPCSA PR[xxx]" wording in the LOCKED brand PDF.
